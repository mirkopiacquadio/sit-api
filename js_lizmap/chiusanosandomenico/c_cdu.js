...
function generatePopupBody2() {
    ...
    html += '<input type="checkbox" name="piano[]" value="pucurbutm">PUC';
    html += '</label>';
    ...
    html += '<label class="checkbox">';
    html += '<input type="checkbox" name="piano[]" value="vincpaesaggisticourbutm">VINCOLO PAESAGGISTICO';
    html += '</label>';
    
    html += '<label class="checkbox">';
    html += '<input type="checkbox" name="piano[]" value="ppurbutm">PIANO PARCO MONTI PICENTINI';
    html += '</label>';
    ...
    html += '<label class="checkbox">';
    html += '<input type="checkbox" name="piano[]" value="zpsurbutm">ZPS';
    html += '</label>';
...
function openCdu(a, b) {
    ...
    var params = {
        ...
        cduprovv: '',
        cducap: '',
        piano: JSON.stringify(['pucurbutm','psaiurbutm', 'vincoliopelegisurbutm', 'viurbutm', 'vincpaesaggisticourbutm', 'ppurbutm', 'sicurbutm', 'apfurbutm', 'zpsurbutm' ]),   
    ...
    var params = {
        ...
        cduprovv: '',
        cducap: '',
        piano: ['pucurbutm','psaiurbutm', 'vincoliopelegisurbutm',  'viurbutm', 'vincpaesaggisticourbutm', 'ppurbutm', 'sicurbutm', 'apfurbutm', 'zpsurbutm' ],    
        uiu: JSON.stringify([{ "fg": a, "plla": b, "sb": "" }]),
        cdusetmq: 1,
        cdusetperc: 1
    };

...
function generatePopupBody2() {
    ...
    html += '<option value="proprietario">Proprietario</option>';
    html += '<option value="delegato">Delegato</option>';
    html += '<option value="incaricato">Incaricato</option>';
    html += '<option value="acquirente">Acquirente</option>';
    html += '</select>';
    html += '</div>';
    html += '<div class="span3">';
    ...
    html += '<label class="checkbox">';
    html += '<input type="checkbox" name="piano[]" value="ptpurbutm">PTP';
    html += '</label>';

    html += '<label class="checkbox">';
    html += '<input type="checkbox" name="piano[]" value="ppurbutm">PIANO PARCO';
    html += '</label>';

    html += '<label class="checkbox">';
    html += '<input type="checkbox" name="piano[]" value="praeurbutm">PRAE - Cave';
    html += '</label>';

    html += '<label class="checkbox">';
    html += '<input type="checkbox" name="piano[]" value="sicurbutm">SIC';
    html += '</label>';
    ...
    html += '<label class="checkbox">';
    html += '<input type="checkbox" name="piano[]" value="acqcarolinourbutm">VINCOLO ACQUEDOTTO CAROLINO';
    html += '</label>';
    ...
    html += '<label class="checkbox">';
    html += '<input type="checkbox" name="piano[]" value="vaurbutm">VINCOLO ARCHEOLOGICO';
    html += '</label>';

    html += '<label class="checkbox">';
    html += '<input type="checkbox" name="piano[]" value="vincoliopelegisurbutm">VINCOLO OPE LEGIS';
    html += '</label>';

    html += '<label class="checkbox">';
    html += '<input type="checkbox" name="piano[]" value="apfurbutm">AREE PERCORSE DAL FUOCO';
    html += '</label>';
    ...
    html += '</label>';
    html += '<legend>Esenzione vincoli</legend>';
    html += '<label class="checkbox" style="margin-top: 20px;">';
    html += '<input type="checkbox" value="1" name="mostraTuttiPianiPrgPuc">Visualizza esenzione vincoli piani comunali vigenti';
    html += '</label>';
    html += '<label class="checkbox" style="margin-top: 20px;">';
    html += '<input type="checkbox" value="1" name="mostraTuttiPiani">Visualizza esenzione vincoli piani sovracomunali';
    html += '</label>';
    html += '</fieldset>';
    html += '</div>';
    html += '</div>';
    ...
    minidockopened: function (e) {
        if (e.id == 'cdu') {
            ...
            if (headerStyles.display == 'none') {
                ...
                height = (parseFloat(sidemenuStyles.height) * 65 / 100);
                width = 1140;
            }
...
function openCdu(a, b) {
    ...
    var params = {
        ...
        cduprovv: '',
        cducap: '',
        piano: JSON.stringify(['prgurbutm', 'psaiurbutm', 'ptpurbutm', 'ppurbutm', 'sicurbutm', 'viurbutm','vaurbutm', 'acqcarolinourbutm', 'usiciviciurbutm', 'vincoliopelegisurbutm', 'praeurbutm', 'apfurbutm' ]),   
    ...
    var params = {
        ...
        cduprovv: '',
        cducap: '',
        piano: [ 'prgurbutm', 'psaiurbutm', 'ptpurbutm', 'ppurbutm', 'sicurbutm', 'viurbutm', 'vaurbutm', 'usiciviciurbutm', 'acqcarolinourbutm', 'vincoliopelegisurbutm', 'praeurbutm', 'apfurbutm' ],    
        uiu: JSON.stringify([{ "fg": a, "plla": b, "sb": "" }]),
        cdusetmq: 1,
        cdusetperc: 1
    };

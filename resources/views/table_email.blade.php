        ...
        <tbody>
            <tr valign="top">
                ...
                <td style="width: 18%; border-left: 0px;vertical-align: middle;">
                    ...
                    <span style="font-size: 15px;">______________</span>
                    <div style="font-size: 15px;"><b>Provincia di</b></div>
                    <span style="font-size: 15px;">______________</span>
                </td>
                ...
                @isset($data_uiu)
                    @foreach ($data_uiu['intersects'] as $key => $dati)
                        @foreach ($dati as $data)
                            <tr>
                                <td class="align-middle" style="width: 20%;"><b>{{ strtoupper(str_replace('urbutm', '', $key)) }}<b></td>
